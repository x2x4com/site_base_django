...
function (_HTMLElement) {
  ...
  _createClass(DataTable, [{
    ...
    value: function connectedCallback() {
      ...
      var n = "true" === this.getAttribute("checkboxes");
      var e = this;
      ...
      n && (this._datatable.on("user-select", function(e, t, n, i, o) {
                "A" === o.target.tagName && e.preventDefault()
      }),
      $("#actionCard").on("click.actionForm", "button", function(t) {
        t.preventDefault();
        var n = $('#actionCard select[name="action_url"]').val()
          , i = Object.keys(e._datatable.settings()[0].checkboxes.s.data[0]);
        if (n && i.length) {
          var o = $("<form action='" + n + "' method='POST'></form>");
          o.append($("#_action_token input")[0]);
          for (var r = 0; r < i.length; r++)
            o.append('<input type="hidden" name="pk" value="' + i[r] + '">');
          $("body").append(o),
              o.submit()
        }
      }))
